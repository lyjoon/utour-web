<template>
  ...
  <v-card elevation="0" outlined>
    <v-list>
      <v-subheader>
        <v-icon :color="color" class="mr-4">mdi-cog</v-icon>
      ...
      <v-list-item>
        ...
        <v-list-item-content>
          <v-list-item-title>메인화면설정</v-list-item-title>
          <v-list-item-subtitle class="caption mt-1">캐로셀, 커머스 유형 상품노출..</v-list-item-subtitle>
        </v-list-item-content>
        <v-list-item-action class="pr-4">
          <v-list-item-action-text><v-chip :color="color" small dark link to="/admin/config/display">관리</v-chip></v-list-item-action-text>
        </v-list-item-action>
      </v-list-item>
