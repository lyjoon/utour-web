  ...
  <div class="pa-4">
    ...
    <div class="pa-4">
      <div class="justify-end flex-fill d-flex">
        <v-btn color="grey lighten-3" elevation="0" @click="$router.push('/admin/notice/edit')">등록</v-btn>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    search: function(){
      noticeApi.getList(this.pagination.page, this.pagination.limit, this.queryType.value, this.query).then(res => {
