    ...
    <div class="grey lighten-4 pa-2">
      <v-layout row class="hidden-md-and-down">
        ...
        <v-flex class="d-flex flex-fill">
          ...
          <div class="d-inline-block pt-4 pb-4 pr-2 pl-4">
          ...
          <div class="flex-fill pt-4 pb-4 pr-4 pl-2">
      ...
      <div class="d-flex flex-fill justify-end pa-1">
        <v-btn dark color="deep-orange" class="darken-2 mt-2" elevation="0" @click="save">
